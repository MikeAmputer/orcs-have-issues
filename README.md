...
> [!IMPORTANT]
> [Alfa test server](https://github.com/MikeAmputer/orcs-have-issues/issues/14) was started on _September 6, 2024_. It is currently stopped due to a lack of players. However, if you'd like to try the game, simply open an issue — I'll see it and gladly start the server, even for a single player. =)
